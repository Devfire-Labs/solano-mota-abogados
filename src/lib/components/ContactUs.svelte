<section id="contact-us" class="bg-quaternary py-10 px-5 text-primary">
	<h2 class="text-xl">Consulta con nosotros</h2>
	<p class="mt-4">
...
<style>
	.text-input {
		@apply mt-3 block w-full border-2 border-gray-400 rounded-md text-center py-0.5;
	}
</style>
